...
namespace Pruebas
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            InitializeComponent();
            movimiento();
            grupoSegmentos = new Serpiente.Snake[] { snake1, snake2, snake3, snake4, snake5, snake6, snake7, snake8, snake9, snake10, snake11, snake12 };
        }
        ...
        protected void moverSegmentos()
        {
            ...
            for (int i = 1; i < snake1.Segmentos + 1; i++)
            {
               ...
               // grupoSegmentos[i].Direccion = grupoSegmentos[i - 1].Direccion;
               // grupoSegmentos[i].Sentido = grupoSegmentos[i-1].Sentido;
            }
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            grupoSegmentos[pos].Direccion = grupoSegmentos[pos - 1].Direccion;
            grupoSegmentos[pos].Sentido = grupoSegmentos[pos-1].Sentido;

            pos++;
            this.Text = "X:" + snake1.Location.X + " Y:" + snake1.Location.Y+" pos:"+pos;
        }
